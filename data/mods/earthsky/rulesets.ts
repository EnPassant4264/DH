export const Formats: {[k: string]: ModdedFormatData} = {
	earthsky: {
		...
		ruleset: [ 'Hidden Move Limit', 'Obtainable', 'Gen 8 Sketch', 'Species Clause', 'Sleep Clause Mod', 'Endless Battle Clause', 'Baton Pass Clause', 'Z-Move Clause', 'Dynamax Clause',
